  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500">End-to-end flow from intake to export-ready</p>
      </div>
            ...
            <div key={stage} className="flex items-center">
              <div className="flex flex-col items-center">
                ...
                >
                  ...
                  <div className="text-[10px] text-slate-400 capitalize">{stage}</div>
                </div>
      ...
      <div className="bg-gradient-to-br from-[#161923]/70 to-[#0f1119]/50 backdrop-blur-xl border border-white/6 rounded-xl overflow-hidden">
        <div className="px-4 py-3 border-b border-white/6">
          ...
          <p className="text-xs text-slate-500">{projects.length} items</p>
        </div>
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/6 text-xs text-slate-500 uppercase">
              <th className="text-left px-4 py-2">Project</th>
              <th className="text-left px-4 py-2">Geo</th>
